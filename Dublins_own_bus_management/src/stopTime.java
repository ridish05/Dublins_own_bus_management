...
public class stopTime
{
    ...
    protected static Map<String, List<stopTime>> generateHashMapOfStopTimes (String pathToStopTimesFile) throws IOException
    {
        ...
        long totalNumberOfLinesInFile = UtilityWork.numberOfLinesInAFile(pathToStopTimesFile)-1;
        ...
        while ((currentLine = reader.readLine()) != null)
        {
            ...
            {
                    UtilityWork.updateProgressBar(counterForProgressBar, totalNumberOfLinesInFile);
            }
        }

        //Once we have successfully read all lines in the file, we have to update the progress bar to represent this.
        UtilityWork.updateProgressBar((int)totalNumberOfLinesInFile, totalNumberOfLinesInFile);
